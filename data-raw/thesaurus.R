...
app_translations <- tibble::tribble(
  ...
  "under_construction_text", "Hem trobat un problema a la base de dades i estem treballant per resoldre'l. Les dades a partir del 10 de maig de 2023 i les dades històriques no estan disponibles en aquests moments.", "We've encountered a problem within the database and we are working is solving it. Data starting from 10th May 2023 and historic data are not available at the moment.", "Hemos encontrado un problema dentro de la base de datos y estamos trabajando para solucionarlo. Los datos a partir del 10 de mayo de 2023 y los datos históricos no están disponibles en este momento.",
  # save
